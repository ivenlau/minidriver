    ...
    >
      <button
        ...
        className={cn(
          ...
          selected ? 'border-accent bg-accent text-white' : cn('border-line bg-surface', anySelected ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'),
        )}
      ...
      <div className="relative flex aspect-4/3 items-center justify-center bg-surface2">
        ...
        <button
          ...
          className={cn(
            ...
            selected ? 'border-accent bg-accent text-white opacity-100' : 'border-line bg-surface opacity-0 group-hover:opacity-100',
          )}
        >
          {selected && (
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
